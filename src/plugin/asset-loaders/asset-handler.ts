...
import serverJS from "../../../server/server.mjs?raw";
...
import serverPackageJSON from "src/assets/server-package.txt";
...
export class AssetHandler
{
	...
	public static serverJS: AssetLoader;
	...
	public static serverPackageJSON: AssetLoader;
	...
	public static async initialize()
	{
		...
		this.serverJS = new AssetLoader("server/server.mjs", serverJS, null, AssetType.Root, InlinePolicy.Download, false, Mutability.Static);
		...
		this.serverPackageJSON = new AssetLoader("server/package.json", serverPackageJSON, null, AssetType.Root, InlinePolicy.Download, false, Mutability.Static);
